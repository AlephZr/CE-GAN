...
parser.add_argument('--eval_criteria', type=str,
                    help='Evaluation criteria Choices: QalD | discriminator | operator_test',
                    default='operator_test')  # QalD is EGAN's standard
...
parser.add_argument('--lambda_f', type=float, help='lambda for EGAN-Fitness', default=0.01)
...
# parser.add_argument('--gradperstep', type=float, help='#Gradient step per env step', default=1)
parser.add_argument('--d_loss_mode', type=str, default='vanilla',
                    help='lsgan | nsgan | vanilla | wgan | rsgan')
parser.add_argument('--g_loss_mode', nargs='*', default=['fitness'],
                    help='lsgan | nsgan | vanilla | wgan | rsgan | fitness')
parser.add_argument('--use_comprehensive_selection', action='store_true', default=False,
                    help='if mutation operator also involved in the selection')
parser.add_argument('--eval_parents', action='store_true', default=False,
                    help='if parents also involved in the selection')
...
# gen = 100000
# model_constructor = ModelConstructor(args, generator_seed='./checkpoint/{0}/netG_{1}.pth'.format(args.dataset_name, gen))
