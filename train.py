...
parser.add_argument('--lambda_f', type=float, help='lambda for EGAN-Fitness', default=0.001)
...
# parser.add_argument('--learning_start', type=int, help='Images to wait before learning starts', default=64)
