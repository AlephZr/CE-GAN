...
class Parameters:
    def __init__(self, parser):
        ...
        self.use_comprehensive_selection = vars(parser.parse_args())['use_comprehensive_selection']
        self.eval_parents = vars(parser.parse_args())['eval_parents']
        ...
        self.savetag += '_eval_criteria' + str(self.eval_criteria)
