...
def toy_generate_image(args, true_dist, gen_dist):
    ...
    plt.savefig('tmp/' + args.dataset_name + '/' + 'frame' + str(frame_index[0]) + '.jpg')
...
def toy_generate_kde(args, generator):
    ...
    ax.savefig('tmp/' + args.dataset_name + '/' + 'kde_frame' + str(kde_frame_index[0]) + '.png')
...
def toy_true_dist_kde(args, true_dist):
    ...
    ax.savefig('tmp/' + args.dataset_name + '/' + 'true_dist.png')
